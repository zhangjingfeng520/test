 ...
 */
package com.example.myapplication.mapapi.clusterutil.projection;
...
public class SphericalMercatorProjection {
    ...
    public LatLng toLatLng(com.example.myapplication.mapapi.clusterutil.projection.Point point) {
