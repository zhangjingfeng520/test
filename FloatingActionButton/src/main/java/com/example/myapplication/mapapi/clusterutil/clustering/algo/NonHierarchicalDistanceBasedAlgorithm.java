...
package com.example.myapplication.mapapi.clusterutil.clustering.algo;


import com.baidu.mapapi.model.LatLng;
import com.example.myapplication.mapapi.clusterutil.clustering.Cluster;
import com.example.myapplication.mapapi.clusterutil.clustering.ClusterItem;
import com.example.myapplication.mapapi.clusterutil.projection.Bounds;
import com.example.myapplication.mapapi.clusterutil.projection.Point;
import com.example.myapplication.mapapi.clusterutil.projection.SphericalMercatorProjection;
import com.example.myapplication.mapapi.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.myapplication.mapapi.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.myapplication.mapapi.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.myapplication.mapapi.clusterutil.clustering.algo.StaticCluster<T> cluster =
                        new com.example.myapplication.mapapi.clusterutil.clustering.algo
