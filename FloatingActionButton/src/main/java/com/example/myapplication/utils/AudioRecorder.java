...
public class AudioRecorder {
    ...
    private int DEFAULT_CHANNELCONFIG_IN = Constants.channelConfigIn;    // 声道配置
    private int DEFAULT_AUDIOFORMAT = Constants.audioFormat;             // 音频格式
    private int DEFAULT_AUDIOSOURCE = Constants.audioSource;             // 音频来源
